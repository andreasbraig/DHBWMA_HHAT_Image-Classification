...
\lstdefinelanguage{html}{
    morekeywords={html, head, title, body, div, span, p, a, img, script, style, link, meta, h1, h2, h3, h4, h5, h6, ul, ol, li, table, tr, td, th, form, input, button, textarea, select, option},
    sensitive=false,
    morecomment=[s]{<!--}{-->},  % HTML-Kommentare
    morestring=[b]"
}
...
\lstdefinestyle{json}{
    ...
    tabsize=4,
    aboveskip=0.5cm   % Abstand über dem Listing
}
...
% Listings-Style für HTML anpassen
\lstdefinestyle{html}{
    language=html,
    basicstyle=\ttfamily\scriptsize,
    numbers=left,
    ...
    commentstyle=\color{green},          % HTML-Kommentare in Grün
    stringstyle=\color{orange},          % Strings in Orange
    showstringspaces=false,
    tabsize=4,
    aboveskip=0.5cm   % Abstand über dem Listing
