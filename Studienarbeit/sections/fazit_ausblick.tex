...
Eine weitere mögliche Fortsetzung dieser Studienarbeit wäre die Implementierung von Ensemble Methoden, bei denen mehrere Modelle kombiniert werden, um die Genauigkeit der Klassifikationsergebnisse zu erhöhen. Dies könnte insbesondere bei komplexen Datensätzen oder anderen \ac{PCB}s von Vorteil sein, bei denen einzelne Modelle möglicherweise nicht die bestmögliche Leistung erzielen.
